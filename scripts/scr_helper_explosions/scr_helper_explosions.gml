function collideExplosion(explObj, collList) {
    for (var i = 0; i < ds_list_size(collList); i += 1) {
        ...
        //Base damage
        damageEntity(collObj, explObj.explOwner, explObj.explDmgVal, explObj.explDmgMult * extraMult, explObj.explDmgType, explObj.explDmgPhys, explObj.explDmgEner,
            explObj.explDmgElem, explObj.explDmgResHit, explObj.dmgCategory);
