...
// Feather disable GM1041
{
    ...
    /// @param {real} _xscale Description
    /// @param {real} [_yscale]=_xscale Description
    /// @param {real} [_angle]=0  {real}
    ...
    /**
     * @param {real} _wrap_max_width
     * @param {real} [_wrap_max_height]=-1
     * @param {bool} [_wrap_per_char]=false
     */
     ...
     * @param {real} _wrap_max_width Description
     * @param {real} _wrap_max_height Description
     * @param {bool} [_wrap_per_char]=false Description
     * @param {real} [_wrap_max_scale]=1 Description
     */
    ...
    /**
     * Function Description
     * @param {any} _x1 Description
     * @param {any} _y1 Description
     * @param {any} _x2 Description
     * @param {any} _y2 Description
     * @param {any} _x3 Description
     * @param {any} _y3 Description
     * @param {any} _x4 Description
     * @param {any} _y4 Description
    ...
    static right_to_left = function(_state)
    {
        ...
        {
            _new_bidi_hint = _state? __SCRIBBLE_BIDI.R2L : __SCRIBBLE_BIDI.L2R;
        }
    ...
    static __update_bbox_matrix = function()
    {
        ...
        if (__bbox_dirty)
        {
            ...
            else
            {
                ...
                _vertex = matrix_transform_vertex(__bbox_matrix, _r, _t, 0); __bbox_obb_x1 = _vertex[0]; __bbox_obb_y1 = _vertex[1];
                _vertex = matrix_transform_vertex(__bbox_matrix, _l, _b, 0); __bbox_obb_x2 = _vertex[0]; __bbox_obb_y2 = _vertex[1];
                _vertex = matrix_transform_vertex(__bbox_matrix, _r, _b, 0); __bbox_obb_x3 = _vertex[0]; __bbox_obb_y3 = _vertex[1];
    ...
    static get_bbox_revealed = function(_x, _y, _typist)
    {
        ...
        {
            _bbox = _model.__get_bbox_revealed(__page, 0, _typist.__window_array[_typist.__window_index], __padding_l, __padding_t, __padding_r, __padding_b);
        }
        ...
        {
            //Avoid using matrices if we can
            _l = _x - __origin_x + _bbox.left;
            _t = _y - __origin_y + _bbox.top;
            _r = _x - __origin_x + _bbox.right;
            _b = _y - __origin_y + _bbox.bottom;
        ...
        else
        {
            ...
            var _vertex = matrix_transform_vertex(__bbox_matrix, _l, _t, 0); _x0 = _x + _vertex[0]; _y0 = _y + _vertex[1];
			// Feather disable once GM1041
            _vertex = matrix_transform_vertex(__bbox_matrix, _r, _t, 0); _x1 = _x + _vertex[0]; _y1 = _y + _vertex[1];
			// Feather disable once GM1041
            _vertex = matrix_transform_vertex(__bbox_matrix, _l, _b, 0); _x2 = _x + _vertex[0]; _y2 = _y + _vertex[1];
			// Feather disable once GM1041
            _vertex = matrix_transform_vertex(__bbox_matrix, _r, _b, 0); _x3 = _x + _vertex[0]; _y3 = _y + _vertex[1];
    ...
    /**
     * Function Description
     * @param {any} _template Description
     * @param {bool} [_on_change]=true Description
     */
     ...
     * @param {any} [_unique_id]=__unique_id Description
     */
    ...
    /**
     * Function Description
     * @param {any*} _speed Description
     * @param {any*} _smoothness Description
     * @param {bool} [_backwards]=false Description
     */
    ...
    /**
     * Function Description
     * @param {any*} _sound_array Description
     * @param {any*} _overlap Description
     * @param {any*} _pitch_min Description
     * @param {any*} _pitch_max Description
     */
