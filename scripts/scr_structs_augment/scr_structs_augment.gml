...
/// @param {bool} [nullObj]=false  Whether this is a null object, intended to be immediately deleted. Default is false
/// @returns {Struct.augmentObj} Augment object struct
function augmentObj(augInfo, nullObj = false) constructor {
	if (!nullObj) {
